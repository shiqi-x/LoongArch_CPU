...
#
# Script generated by Vivado on Sun Feb 22 21:11:39 +0800 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/ComeOn/CPU2/LoongArch_CPU/minicpu_env/soc_verify/run_vivado/project/loongson.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
