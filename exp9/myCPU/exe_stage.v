module exe_stage(
    ...
    input  wire        inst_is_ldw_id,
    // exe_to_id
    output wire [ 4:0] rd_dest_exe,
    output wire        inst_is_ldw_exe,
    output wire [31:0] forward_exe,
    // exe_to_mem
...
assign inst_is_ldw_exe = inst_is_ldw;
assign forward_exe = alu_result;
